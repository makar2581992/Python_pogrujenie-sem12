...
if __name__ == '__main__':
    ...
    student.last_name = 'Рожков'
    student.grades = {'Физика': (4, 5, 3, 5, 3), 'Биология': (3, 3, 4, 5), 'Математика': (3, 5, 5, 5)}
    student.tests = {'Литература': (56, 47), 'Химия': (3, 100, 75, 63)}
    print(student)